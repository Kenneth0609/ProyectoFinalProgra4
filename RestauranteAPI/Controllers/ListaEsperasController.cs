...
namespace RestauranteAPI.Controllers
{
    ...
    public class ListaEsperaController : ControllerBase
    {
        ...
        // ACTUALIZAR ESTADO
        [HttpPut("{id}/estado")]
        public ActionResult<ListaEsperaResponseDTO> ActualizarEstado(int id, [FromBody] ListaEsperaUpdateEstadoDTO updateDTO)
        {
            var result = _listaEsperaService.ActualizarEstado(id, updateDTO.EstadoId);
